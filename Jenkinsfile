  ...
  stages {
        ...
        stage('Update Servicebot repo'){
          ...
          steps{
            ...
            dir('servicebot-checkout-embed'){
                              git(url: "git@github.com:service-bot/servicebot-checkout-embed.git", branch: 'master', credentialsId: "${gitCredentials}")
            ...
            dir('servicebot-billing-settings-embed'){
                              git(url: "git@github.com:service-bot/servicebot-billing-settings-embed.git", branch: 'master', credentialsId: "${gitCredentials}")
            ...
            dir('servicebot-seat-management-embed'){
                                          git(url: "git@github.com:service-bot/servicebot-seat-management-embed.git", branch: 'master', credentialsId: "${gitCredentials}")
